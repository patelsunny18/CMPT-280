...
public class AVLTree280<I extends Comparable<? super I>> extends OrderedSimpleTree280<I> implements Searchable280<I>, Dispenser280<I> {
    ...
    public static void main(String[] args) {
        ...
        // insert 30 so that it goes to the right of 20 and generate a degenerate tree
        ...
        if (failed == 0) {
            ...
            System.out.println("ERROR: Something went wrong with search() or deleteItem() or has()!");
        }
        ...
        T.delete(2);
        if (T.has(2)) {
            System.out.println("ERROR: Found 2 even though it should have been deleted!\n");
            failed++;
        }
        System.out.println(T.toString() + "\n");
        ...
        T.delete(30);
        if (T.has(30)) {
            System.out.println("ERROR: Found 30 even though it should have been deleted!\n");
            failed++;
        }
        System.out.println(T.toString() + "\n");
        ...
        T.delete(9);
        if (T.has(9)) {
            System.out.println("ERROR: Found 9 even though it should have been deleted!\n");
            failed++;
        }
        System.out.println(T.toString() + "\n");
        ...
        T.delete(35);
        if (T.has(35)) {
            System.out.println("ERROR: Found 35 even though it should have been deleted!\n");
            failed++;
        }
        System.out.println(T.toString() + "\n");
        ...
        T.delete(7);
        if (T.has(7)) {
            System.out.println("ERROR: Found 7 even though it should have been deleted!\n");
            failed++;
        }
        System.out.println(T.toString() + "\n");
